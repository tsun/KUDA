...
def train_source(args):
    ...
    torch.save(best_netF, osp.join(args.output_dir_src, "{}_{}_source_F.pt".format(args.s, args.net)))
    torch.save(best_netB, osp.join(args.output_dir_src, "{}_{}_source_B.pt".format(args.s, args.net)))
    torch.save(best_netC, osp.join(args.output_dir_src, "{}_{}_source_C.pt".format(args.s, args.net)))
...
def test_target(args):
    ...
    args.modelpath = osp.join(args.output_dir_src, '{}_{}_source_F.pt'.format(args.s, args.net))
    netF.load_state_dict(torch.load(args.modelpath))
    args.modelpath = osp.join(args.output_dir_src, '{}_{}_source_B.pt'.format(args.s, args.net))
    netB.load_state_dict(torch.load(args.modelpath))
    args.modelpath = osp.join(args.output_dir_src, '{}_{}_source_C.pt'.format(args.s, args.net))
...
if __name__ == "__main__":
    ...
    if args.dset == 'domainnet40':
        ...
        args.test_dset_path = folder + args.dset + '/image_list/' + args.s + '_test_mini.txt'
    ...
    if args.dset == 'office-home':
        ...
        if args.da == 'oda':
            args.class_num = 25
            args.src_classes = [33, 32, 36, 15, 19, 2, 46, 49, 48, 53, 47, 54, 4, 18, 57, 23, 0, 45, 1, 38, 5, 13, 50, 11, 58]
    ...
    for t in args.names:
        if t == args.s or t == args.s.split('_RS')[0]:
            continue
        args.t = t
        # args.name = args.names[args.s][0].upper() + args.t[0].upper()
